...
export class AppHeader extends LitElement {
    static styles = css`
        * {
        ...
        :host-context(.compact-layout) .header {
            padding: 4px 8px;
            min-height: 28px;
        }

        :host-context(.compact-layout) .header-title {
            font-size: 11px;
        }

        :host-context(.compact-layout) .header-actions {
            gap: 4px;
        }

        :host-context(.compact-layout) .button,
        :host-context(.compact-layout) .icon-button {
            padding: 2px 4px;
            font-size: 10px;
        }

        :host-context(.compact-layout) .icon-button svg {
            width: 12px;
            height: 12px;
        }

        :host-context(.compact-layout) .key {
            font-size: 9px;
            padding: 1px 4px;
        }

        /* Hide elapsed time and status in compact mode to save space */
        :host-context(.compact-layout) .header-actions span:not(.click-through-indicator) {
            display: none;
        }
