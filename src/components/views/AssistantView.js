...
export class AssistantView extends LitElement {
    static styles = css`
        ...
        * {
        ...
        :host-context(.compact-layout) .response-container {
            font-size: 13px !important;
            padding: 8px;
            line-height: 1.4;
        }

        :host-context(.compact-layout) .text-input-container {
            margin-top: 4px;
            gap: 4px;
        }

        :host-context(.compact-layout) .nav-button {
            padding: 4px;
        }

        :host-context(.compact-layout) .nav-button svg {
            width: 14px;
            height: 14px;
        }

        :host-context(.compact-layout) .screen-answer-btn {
            font-size: 10px;
            padding: 4px 8px;
        }

        :host-context(.compact-layout) .screen-answer-btn svg {
            width: 12px;
            height: 12px;
        }

        :host-context(.compact-layout) .response-counter {
            font-size: 10px;
            min-width: 30px;
        }
